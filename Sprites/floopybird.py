...
def draw_floor():
    ...
    screen.blit(floor_surface,(floor_x_pos + 650,750))
...
pygame.init()
screen = pygame.display.set_mode((550, 790))
...
death_sound = pygame.mixer.Sound('audio\sfx_die.wav')
...
bird_rect = bird_surface.get_rect(center = (100,395))

BIRDFLAP = pygame.USEREVENT +1
pygame.time.set_timer(BIRDFLAP,200)

pipe_surface = pygame.image.load('sprites/pipe-red.png').convert()
pipe_surface = pygame.transform.scale2x(pipe_surface)
pipe_list = []
SPAWNPIPE = pygame.USEREVENT
pygame.time.set_timer(SPAWNPIPE, 1200)

pipe_height = [600,400,550] 
game_over_surface = pygame.transform.scale2x(pygame.image.load('sprites/message.png').convert_alpha())
game_over_rect = game_over_surface.get_rect(center = (275,395))
